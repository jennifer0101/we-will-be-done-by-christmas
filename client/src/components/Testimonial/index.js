...
function testimonial() {
    return (
        ...
        <div className="row">
            <div className="col m4">
                <div className="card blue-grey darken-1">
                    ...
                    <div className="text-center"><i class="fas fa-utensils fa-5x"></i></div>
                        <div>
        ...
        <div className="col m4">
            <div className="card blue-grey darken-1">
                <div className="card-content white-text">
                <div className="text-center"><i class="far fa-money-bill-alt fa-5x"></i></div>
                <div>
        ...
        <div className="col m4">
            <div className="card blue-grey darken-1">
                <div className="card-content white-text">
                <div className="text-center"><i class="fas fa-seedling fa-5x"></i></div>
                <div>
